			...
			<div class="row align-items-center justify-content-between">
				...
				<nav class="user-menu">
					<ul class="user-menu__list">
						...
						<?php } else { ?>
							<li class="user-menu__item" onclick="delAccount()">Hello, <?= $_SESSION["user"] ?></li>
		...
		<div class="container">
			<div class="row">
				...
				<div class="main-content">
					<h1><?php echo $_GET["cat"] = ($_GET["cat"] ? $_GET["cat"] : "phones"); ?></h1>
					<div class="products">
						<?php
						...
						for ($i = 0; $i < count($res); $i++) { ?>
							<div class="product">
								...
								<form action="add_to_basket.php" method="POST" class="buy-form">
